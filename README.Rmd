...
The following app on Shiny <https://maxal1986.shinyapps.io/Iris_app/> is a very simple app that helps to predict the Species of an Iris flower according to the dimension of its Sepal and its Petal.
